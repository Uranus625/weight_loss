...
static constexpr auto qt_meta_stringdata_ZN14ReceiverWorkerE = QtMocHelpers::stringData(
    "ReceiverWorker",
    "dataReceived",
    "",
    "data",
...
Q_CONSTINIT static const uint qt_meta_data_ZN14ReceiverWorkerE[] = {
...
Q_CONSTINIT const QMetaObject ReceiverWorker::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14ReceiverWorkerE.offsetsAndSizes,
    qt_meta_data_ZN14ReceiverWorkerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14ReceiverWorkerE_t,
        // Q_OBJECT / Q_GADGET
...
void ReceiverWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ReceiverWorker::*)(const QByteArray & );
            if (_q_method_type _q_method = &ReceiverWorker::dataReceived; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *ReceiverWorker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14ReceiverWorkerE.stringdata0))
...
// SIGNAL 0
void ReceiverWorker::dataReceived(const QByteArray & _t1)
{
